...
export function simulateOverflow(files, limit, strategy = 'combined') {
...
export function generateOptimizationSuggestions(files, totalTokens, limit, strategy, saved) {
    const suggestions = [];
...
//# sourceMappingURL=overflow-simulator.js.map